...
// Next.js automatically looks for a file named exactly not-found.tsx to handle broken links.
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] text-center px-4">
      ...
      {/* We use the Next.js Link component instead of an anchor tag for instant, instant navigation. */}
